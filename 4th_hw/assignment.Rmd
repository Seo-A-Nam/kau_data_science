...
# attrition data 불러오기
```{r}
# Load dataset (attrition dataset)
...
```{r}
# create test data set, and convert chr data to numeric
# get correlation coef value for each attribute
...
```{r}
# Make full-tree, with selected predictor variable set
library(caret)
library(rpart)
library(ggplot2)
library(rattle)
